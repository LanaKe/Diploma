...
writer = SummaryWriter('runs/test425')
...
class TrainingConfig:
    ...
    output_dir = "test425_outputdir"  # the model name locally and on the HF Hub
    seed = 0
...
def evaluate(config, epoch, pipeline):
    ...
    global stevec
    stevec+=1
    images.save(f'test425/output_{stevec}.png')
    ...
    for epoch in range(config.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(model):
                ...
                loss = mse_loss(noise_pred, noise, reduction="sum")
